...
namespace PriorityQueueDemo
{
    ...
    public class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
    {
        ...
        private Dictionary<string, TValue> stateDictionary = new Dictionary<string,TValue>();
        ...
        /// pstanden - butchered to include string param
        /// </summary>
        /// <param name="priority">element priority</param>
        /// <param name="value">element value</param>
        public void Enqueue(TPriority priority, TValue value, string state)
        {
            Insert(priority, value);
            stateDictionary.Add(state, value);
        }
        ...
        public void DeleteFromStateDictionary(string state)
        {
            this.stateDictionary.Remove(state);
        }

        public bool ContainsState(string state)
        {
            return this.stateDictionary.ContainsKey(state);
        }
